/**
 * @file SearchForBall_1.h
 *
 * This option is for the Striker.But now all the roles use the same model.
 *
 ...
 * @author Xuanzhi Wang
 */
option(SearchForBall_1, (float) x, (float) y, (float)(1.047f) turnSpeed, (float)(0.3f) commonSpeed) {
