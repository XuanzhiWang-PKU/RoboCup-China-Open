/**
 * @file SearchForBall_2.h
 *
 * This option is for the Supporter_1.But now all the roles use the same model.
 * 
 ...
 * @author Xuanzhi Wang
 */
option(SearchForBall_2, (float) x, (float) y, (float)(1.047f) turnSpeed, (float)(0.3f) commonSpeed) {
