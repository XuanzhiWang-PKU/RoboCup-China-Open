/**
 * @file SearchForBall_3.h
 *
 * This option is for the Supporter_2.But now all the roles use the same model.
 *
 ...
 * @author Xuanzhi Wang
 */
option(SearchForBall_3, (float) x, (float) y, (float)(1.047f) turnSpeed, (float)(0.3f) commonSpeed) {
