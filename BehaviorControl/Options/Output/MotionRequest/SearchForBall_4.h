/**
 * @file SearchForBall_4.h
 *
 * This option is for the defender.But now all the roles use the same model.
 *
 ...
 * @author Xuanzhi Wang
 */
option(SearchForBall_4, (float) x, (float) y, (float)(1.047f) turnSpeed, (float)(0.3f) commonSpeed) {
